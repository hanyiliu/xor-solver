...
#Training
network_size = (5,2) #neurons per layer, number of layers #TODO: cannot change layers, must fix
random_theta = True
alpha = 1 #alpha value
iterations = 1000
...
input = 3 #number of input units
output = 2 #number of output units

theta_dir = "data/theta.txt"
input_dir = "data/input.txt"
